...
# $Header: /var/cvsroot/gentoo-x86/games-rpg/opentibia-server/opentibia-server-0.7.0.ebuild,v 1.2 2015/02/16 21:48:13 grepwood Exp $

EAPI=5
inherit eutils games

DESCRIPTION="OpenTibia server"
...
IUSE=""
REQUIRED_USE="^^ ( mysql odbc postgres sqlite )"

DEPEND="!luajit? ( <dev-lang/lua-5.2.0 )
